    ...
    <div className='container mx-auto px-4 sm:px-6 md:px-16 lg:px-28'>
      ...
      <div className='block md:hidden relative overflow-hidden rounded-lg bg-red-500'>
        ...
        <div   className='absolute inset-0  left-0 w-full'>
          ...
          <p className='font-sharp font-semibold text-[16px] leading-[16px] tracking-[0] text-center text-[#F36E3F]'>
            MadBoost.gg
          </p>
          <p className='font-sharp font-semibold text-[16px] leading-[16px] tracking-[0] text-center text-white'>
            Essential FAQs
          </p>
          </div>
        </div>
